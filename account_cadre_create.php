    ...
    <div class="main-container">
        ...
        <div class="main-content view-info-account-management d-flex">
            <div class="data-query">
                ...
                $type = $_GET['type'];
                if ($type == 1) {
                    echo "<div class='page-title'>Create New Admin Account</div>";
                } else if ($type == 2) {
                    echo "<div class='page-title'>Create New Educational Affair Account</div>";
                }
                ?>

                <form action="./php/create_cadre_account.php" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <input required autocomplete="off" type="text" name='lastName' class="form-control">
                    </div>
                    ...
                    <button style='margin-left: 400px; margin-top: 20px;' class='btn btn-primary'>Save and Send Email</button>
                </form>
            </div>
        </div>
