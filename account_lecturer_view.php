        ...
        <div class="main-content view-info-account-management ">
            <div class="info d-flex justify-content-between">
                <div class="data-query" >
                    ...
                    $userID = getDataFromTheSameTable("ID", "account", "ID", "$ID", $conn);
                ...
                <div class="image-view-info ">
                    ...
                    if ($imageID == "0" || $imageID == "") {
                        ...
                        $imgPath = getDataFromTheSameTable('imgPath', 'account_info_image', 'accountID', "", $conn);
            ...
            <div class="row header-table">
                ...
                <div class="col col-3">CourseName</div>
                <div class="col col-3">Class</div>
                <div class="col col-2">No of Student</div>
                <div class="col col-3">Duration</div>
            </div>
            <?
                $data = $conn->query("SELECT * from class WHERE taughtBy = '$ID'");
                while($row = $data->fetch_assoc()){
                    ...
                    <div class='col col-2'>$quantity / $mquantity</div>
