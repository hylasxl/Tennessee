...
<body>
        ...
        <div class="main-content">
            <div class="data-query">
                ...
                <div class="changable-data">
                    <?
                        $data = $conn->query("SELECT * FROM class");
                        while($row = $data->fetch_assoc()){
                            ...
                            <button class='btn btn-primary view_detail_class' id='$row[ID]'>View Details</button>
                            </div>
                        </div>";
                        }
                    ?>
    ...
    <div class='add_account_cadre_group'>
        <button class='btn btn-warning add-class'>Create New Class</button>
