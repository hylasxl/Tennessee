...
<body>
    ...
    <div class="container-fluid under-header d-flex align-items-center justify-content-between">
        <div class="nav-text align-items-center ">
            <a href="#" class="text-white text-decoration-none d-none d-md-block" >COMPLAINTS FORM</a>
            <a href="#" class="text-white text-decoration-none d-block d-md-none" >Complaints form</a>
    ...
    <div class="main-picture-about position-relative">
        <img src="./assets/complaintsform.png" class="">
        <p class=" text-white text-in-main-picture position-absolute">COMPLAINTS FORM</p>
    </div>

<!-- FORM -->
<div class="booktourtitle container d-flex flex-column justify-content-center align-items-center">
    <p class="book-tour-form-title text-color1 fw-bold">COMPLAINTS FORM</p>
    <form action="">
        <div class="container-fluid complaint-form d-flex flex-column ">
            <div class="row complaint-row-form mb-5">
                <div class="col col-12 col-md-4 ">
                    <p>Complainant First Name <span class="req">*</span></p>
                </div>
            ...
            <div class="row complaint-row-form mb-5">
                <div class="col col-12 col-md-4 ">
                    <p>Complainant Surname <span class="req">*</span></p>
                </div>
                <div class="col col-12 col-md-8 mb-1">
            ...
            <div class="row complaint-row-form mb-5">
                ...
                <div class="col col-12 col-md-8 mb-1">
                    <input autocomplete='off' type="number" required placeholder="Phone Number">
                </div>
            </div>
            <div class="row complaint-row-form mb-5">
                <div class="col col-12 col-md-4 ">
                ...
                <div class="col col-12 col-md-8 mb-1">
                    <input autocomplete='off' type="email" required placeholder="Email">
                </div>
            </div>
            <div class="row complaint-row-form mb-5">
                <div class="col col-12 col-md-4 ">
                    <p>Prefered Method of Contact<span class="req">*</span></p>
                </div>
                <div class="col col-12 col-md-8 mb-1">
                    <input autocomplete='off' type="text" required placeholder="Email or Phone">
                </div>
            </div>
            <div class="row complaint-row-form mb-5">
                <div class="col col-12 col-md-4 ">
                    <p>Person/Subject of Complainant Fullname<span class="req">*</span></p>
                </div>
                <div class="col col-12 col-md-8 mb-1">
                    <input autocomplete='off' type="text" required placeholder="Person/Subject of Complainant Fullname">
                </div>
            </div>
            <div class="row complaint-row-form mb-5">
                <div class="col col-12 col-md-4 ">
                    <p>Complaint communicated or reported to<span class="req">*</span></p>
                </div>
                <div class="col col-12 col-md-8 mb-1">
                    <input autocomplete='off' type="text" required placeholder="Complaint communicated or reported to">
                </div>
            </div>
            <div class="row complaint-row-form mb-5">
                <div class="col col-12 col-md-4 ">
                    <p>Incident Location<span class="req">*</span></p>
                </div>
                <div class="col col-12 col-md-8 mb-1">
                    <input autocomplete='off' type="text" required placeholder="Incident Location">
                </div>
            </div>
            
            <div class="row complaint-row-form mb-5">
                <div class="col col-12 col-md-4 ">
                    <p>Incident Description<span class="req">*</span></p>
                </div>
                <div class="col col-12 col-md-8 mb-1">
                    <input autocomplete='off' type="text" required placeholder="Please provide a description of the incident">
                </div>
            </div>
            <div class="row complaint-row-form mb-5">
                <div class="col col-12 col-md-4 ">
                    <p>Witness/es<span class="req">*</span></p>
                </div>
                <div class="col col-12 col-md-8 mb-1">
                    <input autocomplete='off' type="text" required placeholder="Witness/es">
                </div>
            </div>
        </div>

        <div class="d-flex justify-content-center">
            <button class="complaint-form-submit-btn">SUBMIT</button>
        </div>
    </form>
