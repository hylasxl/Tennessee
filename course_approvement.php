        ...
        <div class="main-content">
            <div class="data-query">
                ...
                <div class="changable-data">
                    <?
                    $data = $conn->query("SELECT * FROM course where approveStatus ='pending'");
                    while($row = $data->fetch_assoc()){
                        ...
                        <div class='col col-1'>$language</div>
                        <div class='col col-1'>$noLesson</div>
                        <div class='col col-2'>$row[numberofStudyingHour]:00:00</div>
                        <div class='col col-2'>$firstName $lastName - ID: $row[createdBy]</div>
                        <div class='col col-2'>
                        <button class='btn btn-primary course-details' id='$row[ID]'> View Details</button>
                        </div>
                        </div>");
                    }
                    ?>
