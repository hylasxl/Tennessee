        ...
        <div class="sidebar">
            ...
            <div class='type-2 d-none'>
                ...
                <a href="./edu_stu_request.php" class="field-tag">
                    <div class="field-group">
                        <i class="fa-solid fa-code-pull-request" style="color: #ffc017;"></i>
                        <div class="title-field active-tag">Student's Absent Request</div>
                    </div>
                </a>
        ...
        <div class="main-content">
            <div class="data-query">
                <div class="row header-table">
                    ...
                    <div class="col col-3">Reason</div>
                ...
                <div class="changable-data">
                    <?
                        $userID = $_SESSION['LoginAccountID'];
                        $data = $conn->query("SELECT * FROM student_absent_request order by case when status ='pending' then 1 when status ='approved' then 2  when status = 'rejected' then 3 end");
                        while($row = $data->fetch_assoc()){
                            ...
                            if($status == "Pending"){
                                $btn_str = "<button id='$row[ID]' class='btn btn-success ab-appr'> Approve
                                </button>
                                <button id='$row[ID]' class='btn btn-danger ab-rej'> Reject
                                </button>";
                            } else $btn_str = $status;
                            echo " <div class='row'>
                            ...
                            <div class='col col-1'>$row[fromDate]</div>
                            <div class='col col-1'>$row[toDate]</div>
                            <div class='col col-3'>$row[reason]</div>
                            <div class='col col-2'>
                            $btn_str
                            </div>
