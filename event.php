    ...
    font-weight: 600;">
            ...
            <div class="sidebar-topic d-flex flex-column ps-3 mt-5">
                ...
                <div class="tag-group ofedu d-none mt-3">
                    ...
                    <a href="./event.php" class="" style="opacity: 1; text-decoration: underline;">Events</a>
                </div>
                <div class="tag-group ofedu d-none mt-3">
        ...
        <div class="content" style="width: 95% !important; padding-left: 230px !important;">
            ...
            <div class="filter-container ps-4 pt-4 d-flex flex-row align-items-center mb-4 ">
                ...
                <div class="filter-group ms-3 d-flex flex-row">
                    <p class="me-4">From:</p>
                    <input autocomplete='off' type="text" id="from-date" style="width: 150px; height: 30px;  color: #d31245;" onchange="
                    $('.data-query').load('./php/event_filter.php',{
                        from: this.value,
                        to: $('#to-date').val(),
                    ...
                    ">
                    <p class="me-4 ms-4">To:</p>
                    <input autocomplete='off' type="text" id="to-date" style="width: 150px; height: 30px; color: #0d47a1;" onchange="
                    $('.data-query').load('./php/event_filter.php',{
                        to: this.value,
                        from: $('#from-date').val(),
                        name: $('#name-search').val(),
                    ...
                    <input autocomplete='off' id="name-search" type="text" placeholder="Search by name" style="width: 250px; height: 30px; color: #0d47a1;" value="" onkeyup="
                    $('.data-query').load('./php/event_filter.php',{
                        from: $('#from-date').val(),
                        to: $('#to-date').val(),
                        name: this.value,
                    ...
                    ">
                    <p class="me-4 ms-4">Status</p>
                    <select name="status" id="status" style="width: 200px; height: 30px" onchange="
                        $('.data-query').load('./php/event_filter.php',{
                        to: $('#to-date').val(),
                        from: $('#from-date').val(),
                        name: $('#name-search').val(),
            ...
            <div class="data-row container w-100 justify-content-center ms-3 me-3">
                <div class="row mt-2">
                    ...
                    <div style="background-color: #1a2d59; color: white;" class="col col-3  text-center border border-2 ">Name of Event</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-2 text-center border border-2 ">DateTime</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-1 text-center border border-2 ">No of Enroll</div>
                ...
                <div class="data-query">
                    ...
                    require "./php/dbconnect.php";
                    $data = $conn->query("SELECT * FROM event where state ='visible'");
                    if($data->num_rows < 1){
                    ...
                    while ($row = $data->fetch_assoc()) {
                        ...
                        if($row['status'] == 'delayed'){
                            ...
                            <button class='event-info-btn mt-2' id='$row[id]' style='width: 80%; border: none; color: white; background-color: #053B50;'>List</button>";
                        }
            ...
            <button style="margin-left: 1000px; background-color:#d31245; border: none; outline: none; color: white; height: 30px; width: 180px;" class="mt-5 event-add-new">Add new event</button>
