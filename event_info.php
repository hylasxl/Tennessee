    ...
    font-weight: 600;">
            ...
            <div class="sidebar-topic d-flex flex-column ps-3 mt-5">
                ...
                <div class="tag-group ofedu d-none mt-3">
                    ...
                    <a href="./event.php" class="" style="opacity: 1; text-decoration: underline;">Events - Info</a>
                </div>
                <div class="tag-group ofedu d-none mt-3">
        ...
        <div class="content" style="width: 95% !important; padding-left: 230px !important;">
            ...
            <div class="row mt-2 ms-2">
                    ...
                    <div style="background-color: #1a2d59; color: white;" class="col col-1  text-center border border-2 ">Salutation</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-2 text-center border border-2 ">Full Name</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-2 text-center border border-2 ">Address</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-2 text-center border border-2 ">Email</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-1 text-center border border-2 ">Phone</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-1 text-center border border-2 ">Country</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-1 text-center border border-2 ">N.Attend </div>

            </div>
            <?php   
                include ("./php/dbconnect.php");
                $id = $_GET['id'];
                $data = $conn->query("SELECT * FROM tour_booking_request WHERE eventID ='$id'");
                if($data->num_rows < 1){
                ...
                while($row = $data->fetch_assoc()){
                    ...
                    <div class=\"col text-center col-1  \">$row[salutation]</div>
                    <div class=\"col text-center col-2 \">$row[first_name] $row[last_name]</div>
                    <div class=\"col text-center col-2 \">$row[address]</div>
                    <div class=\"col text-center col-2 \">$row[email]</div>
                    <div class=\"col text-center col-1 \">$row[phone]</div>
                    <div class=\"col text-center col-1 \">$row[country]</div>
                    <div class=\"col text-center col-1 \">$row[numofattendance]</div>
                </div>
                ");
                }
            ?>
