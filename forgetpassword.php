...
<body>
    ...
    <div class="container-fluid w-100 d-flex justify-content-center mt-4">
        <div class="login-form w-50 border border-4 p-2  ">
            ...
            <p class="text-center fw-bold fst-italic fs-4">Reset Password Form</p>
            <form action="./php/forgetpassword.php" method="POST">
                ...
                <div class="mb-3 ms-3 me-3">
                <p>Email</p>
                    <input autocomplete='off' type="email" name="email" class="form-control" id="accountPassword" aria-describedby="emailHelp">
                  </div>
