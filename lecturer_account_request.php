            ...
            <div class='type-1 d-none'>
                ...
                <a href="./lecturer_account_request.php" class="field-tag">
                    <div class="field-group">
                        ...
                        <div class="title-field active-tag">Lecturer Account Requests</div>
                    </div>
                </a>
        ...
        <div class="main-content">
            <div class="data-query">
                ...
                <div class="changable-data">
                    <?
                    $requests = $conn->query("SELECT * FROM lecturer_account_providing_request WHERE status ='pending'");
                    while ($row = $requests->fetch_assoc()) {
                        ...
                        $btn_str = "<button class='btn btn-success lec_approve' id='$row[ID]'>Approve</button>
                        <button class=' lec_acc_reject btn btn-danger ' id='$row[ID]'>Reject</button>
                        ";
                        echo ("<div class='row'>
