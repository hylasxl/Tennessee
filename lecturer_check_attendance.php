        ...
        <div class="main-content">
            <div class="data-query">
                <div class="row header-table">
                    ...
                    <div class="col col-1">Class Order</div>
                ...
                <div class="changable-data">
                    <?
                        $data = $conn->query("SELECT * FROM class where taughtBy = '$userID'");
                        while($row = $data->fetch_assoc()){
                            ...
                            $taughtByID = $row['taughtBy'];
                            $startDate = $row['startDate'];
                            $lecturer = getDataFromTheSameTable('firstName','account_info','accountID',$taughtByID,$conn)." ".getDataFromTheSameTable('lastName','account_info','accountID',$taughtByID,$conn);
                            echo "<div class='row'>
                            <div class='col col-1'>$row[ID]</div>
                            <div class='col col-2'>$row[className]</div>
                            <div class='col col-2'>$courseName</div>
                            <div class='col col-1'>$language</div>
                            <div class='col col-1 text-center'>$row[oderofClassbyCourse]</div>
                            <div class='col col-2'>$startDate</div>
                            <div class='col col-1 text-center'>$row[currentQuantity] / $row[maxQuantity]</div>
                            <div class='col col-2 text-center'>
                            <button class='btn btn-primary check_attendance_lec' id='$row[ID]'>Check Attendance</button>
                            </div>
                        </div>";
                        }
                    ?>
