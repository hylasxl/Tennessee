    ...
    font-weight: 600;">
            ...
            <div class="sidebar-topic d-flex flex-column ps-3 mt-5">
                ...
                <div class="tag-group ofedu d-none">
                    ...
                    <a href="./course_management.php" class="" style="opacity: 1; text-decoration: underline;">Courses - Lessons</a>
                </div>
        ...
        <div class="content" style="width: 95% !important; padding-left: 230px !important;">
           ...
           <?
                 ...
                 $id = $_GET['id'];
                 $name = $conn->query("SELECT * FROM course where id='$id'");
           ...
           ?>
            ...
            <div class="row mt-2">
                    ...
                    <div style="background-color: #1a2d59; color: white;" class="col col-1  text-center border border-2 ">Lesson No.</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-4  text-center border border-2 ">Lesson Name</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-2  text-center border border-2 ">Date</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-1 text-center border border-2 ">Start Time</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-1 text-center border border-2 ">End Time</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-1 text-center border border-2 ">Duration</div>
                    <div style="background-color: #1a2d59; color: white;" class="col col-2 text-center border border-2 ">Room</div>
                ...
                <div class="data-query">
                    ...
                    while($row = $data->fetch_assoc()){
                        $roomID = $row['roomID'];
                        $roomName = $conn->query("SELECT * FROM room where id = '$roomID'");
                        ...
                        <div class=\"col text-center col-1 fw-bold \">$row[orderLes]</div>
                        <div class=\"col text-center col-4 \">$row[name]</div>
                        <div class=\"col text-center col-2 \">$row[date]</div>
                        <div class=\"col text-center col-1 \">$row[time_start]</div>
                        <div class=\"col text-center col-1 \">$row[time_end]</div>
                        <div class=\"col text-center col-1 \">$row[duration]</div>
                        <div class=\"col text-center col-2 \">$roomName</div>
