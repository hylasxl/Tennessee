...
<body>
    ...
    <div class="container-fluid under-header d-flex align-items-center justify-content-between">
        <div class="nav-text align-items-center d-flex">
            ...
            <a href="#" class="text-white text-decoration-none d-none d-md-block" >SIGN IN</a>
        ...
        <div class="login-form w-50 border border-4 p-2  ">
            ...
            <form action="./php/login.php" method="POST">
                <div class="mb-3 ms-3 me-3">
                    <p>Username</p>
                    <input autocomplete='off' type="text" name="username" class="form-control" id="accountID" aria-describedby="emailHelp">
                    <div id="emailHelp"  class="form-text">We'll never share your private account with anyone else.</div>
                  </div>
                <div class="mb-3 ms-3 me-3">
                <p>Password</p>
                    <input autocomplete='off' type="password" name="password" class="form-control" id="accountPassword" aria-describedby="emailHelp">
                  </div>

                  
                    <a href="./forgetpassword.php" style="text-decoration: none; opacity: 0.5;" class="m-3">Forget Password?</a>
