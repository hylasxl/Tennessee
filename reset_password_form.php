...
<body>
    ...
    <div class="container-fluid under-header d-flex align-items-center justify-content-between">
        <div class="nav-text align-items-center d-flex">
            ...
            <a href="#" class="text-white text-decoration-none d-block d-md-none" >Reset password</a>
        </div>
        
    </div>
 
    <div class="container-fluid w-100 d-flex justify-content-center mt-4">
        <div class="login-form w-50 border border-4 p-2  ">
            <p class="text-center fw-bold  fs-5">Tennessee Language Center</p>
            <p class="text-center fw-bold fst-italic fs-4">Reset Password</p>
            <form action="./php/reset_password_confirm.php?username=<?php
            $username  =  $_GET['username'];
            echo $username;
            ?> " method="POST">
                <div class="mb-3 ms-3 me-3">
                    <p>New Password</p>
                    <input autocomplete='off' minlength="8" type="text" name="new" class="form-control" id="accountID" aria-describedby="emailHelp" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                    <div id="emailHelp"  class="form-text">We'll never share your private account with anyone else.</div>
                  </div>
                <div class="mb-3 ms-3 me-3">
                <p>Confirm your password</p>
                    <input autocomplete='off' minlength="8" type="text" name="confirm" class="form-control" id="accountPassword" aria-describedby="emailHelp" required>
                  </div>

                  
                    
                  <div class="login d-flex">
                    <button class="login-btn w-100">Sign in</button>
                  </div>
            </form>
        </div>
    </div>
