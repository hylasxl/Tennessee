...
<body>
        ...
        <div class="main-content">
            <div class="data-query">
                <div class="row header-table">
                    ...
                    <div class="col col-4">Reason</div>
                ...
                <div class="changable-data">
                    <?
                        $userID = $_SESSION['LoginAccountID'];
                        $data = $conn->query("SELECT * FROM student_absent_request WHERE studentID ='$userID'");
                        while($row = $data->fetch_assoc()){
                            ...
                            <div class='col col-2'>$row[fromDate]</div>
                            <div class='col col-2'>$row[toDate]</div>
                            <div class='col col-4'>$row[reason]</div>
                            <div class='col col-1'>$status</div>
    ...
    <div class='add_account_cadre_group'>
        <button class='btn btn-warning absent-request'>Create New Absent Request</button>
