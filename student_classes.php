        ...
        <div class="main-content">
            <div class="data-query">
                <div class="row header-table">
                    ...
                    <div class="col col-2">Lecturer</div>
                ...
                <div class="changable-data">
                    <?
                        ...
                        // echo "SELECT * FROM student_class_list where studentID = '$userID'";
                        while($row = $data->fetch_assoc()){
                            $classID = $row['classID'];
                            $class = $conn->query("SELECT * FROM class where ID = '$classID'");
                            $class = $class->fetch_assoc();
                            $taughtByID = $class['taughtBy'];
                            ...
                            <div class='col col-2'>$className</div>
                            <div class='col col-2'>$courseName</div>
                            <div class='col col-1'>$language</div>
                            <div class='col col-1 text-center'>$class[oderofClassbyCourse]</div>
                            <div class='col col-2'>$lecturer</div>
                            <div class='col col-1 text-center'>$class[currentQuantity] / $class[maxQuantity]</div>
                            <div class='col col-2 text-center'>
                            <button class='btn btn-primary view_detail_class_lec' id='$class[ID]'>View Details</button>
                            </div>
                        </div>";
                        }
                    ?>
