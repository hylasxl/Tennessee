    ...
    font-weight: 600;">
            ...
            <div class="sidebar-topic d-flex flex-column ps-3 mt-5">
                ...
                <div class="tag-group ofedu d-none mt-3">
                    ...
                    <a href="./student_management.php" style="opacity: 1; text-decoration: underline;"  class="">Students</a>
                </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        } else window.location.replace(`./php/send_account_request.php?firstname=${firstname}&lastname=${lastname}&email=${email}&phone=${phone}&gender=${gender}&dateofbirth=${dateofbirth}&type=${4}`);
        ...
        <div class="title-content w-100 d-flex justify-content-center fs-3 fw-bold mb-2" style='margin-top: 15px !important;'>
                ...
                <button style='width: 160px; height: 40px; margin-left: 500px;  font-size: 1rem; border: none; outline: none; color: white; background-color: #11772d;' data-bs-toggle="modal" data-bs-target="#addTeacher">+Add new student</button>
            </div>
            <hr>
            ...
            <div class="data-row container w-100 justify-content-center ms-3 me-3">
                <div class="row mt-2">
                    ...
                    <div style="background-color: #1a2d59; color: white;" class="col col-2 text-center border border-2 ">No of Course</div>
                ...
                <div class="data-query">
                    ...
                    require "./php/dbconnect.php";
                    $data = $conn->query("SELECT acc.account_id, acci.first_name, acci.last_name, acci.date_of_birth, acci.gender FROM account_info as acci inner join account as acc on acc.account_id = acci.account_id where acc.account_type = '4'");
                    while($row = $data->fetch_assoc()){
                        $courseData = 0;
                       try {
                        $course = $conn->query("select count(id) from course_enroll where studentID = '$row[account_id]'");
                        $course = $course->fetch_assoc();
                        $courseData = $course['count(id)'];
                       } catch (Exception $e){
                        $courseData = 0;
                       }
                        $gender = "O";
                        ...
                        <div class=\"col text-center col-2 \">$courseData</div>
