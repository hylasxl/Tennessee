...
<body>
        ...
        <div class="main-content">
            <div class="data-query">
                <div class="row header-table">
                    ...
                    <div class="col col-2">No. Registered Course</div>
                    <div class="col col-2">Action</div>
                </div>
                <div class="changable-data">
                    <?php
                        
                        $data = $conn->query("SELECT * FROM account where accountType = 4");
                        while($row = $data->fetch_assoc()){
                            ...
                            $class_count = $conn->query("SELECT count(ID) from class_student_list where studentID = '$ID'");
                            $class_count = $class_count->fetch_assoc();
                            $class_count = $class_count['count(ID)'];
                            $button_str=" <button id='$ID' class='btn btn-primary view-student-info'>
                            View Details
                        </button>";
                            ...
                            <div class='col col-2'>$fullName</div>
                            <div class='col col-1'>$gender</div>
                            <div class='col col-2 text-center'>$dateofBirth</div>
                            <div class='col col-2'>$email</div>
                            <div class='col col-2 text-center'>$class_count</div>
    ...
    <div class='add_account_cadre_group'>
        <button class='btn btn-warning create-student'>Send Request To Create New Student Account</button>
    </div>
