        ...
        <div class="sidebar d-flex flex-column position-fixed ">
            ...
            <div class="sidebar-topic d-flex flex-column ps-3 mt-5">
                ...
                <div class="tag-group ofstudent d-none">
                    ...
                    <a href="./student_calendar.php" style="opacity: 1; text-decoration: underline;" class="">Calendar</a>
                </div>
        ...
        <div class="content">
            ...
            <div class="data-row container w-100 justify-content-center ms-3 me-3">
                <div class="row mt-2">
                    ...
                    <div style="background-color: #1a2d59; color: white;" class="col col-2 text-center border border-2 ">Action</div>
                ...
                <div class="data-query">
                    ...
                    $data = $conn->query("SELECT * FROM course where taughtBy ='$id'");
                    if($data->num_rows < 1){
                    ...
                    <div class=\"col  col-2 fw-bold  \">$row[name]</div>
                    ...
                    <div class=\"col text-center col-2 \">
                        <button id='$courseID' style='width: 70%; border: none; background-color: #004225; color: white;'  class='view_btn'>Check Attendance</button>
                    </div>
                    </div>
                ");
                    }
                    echo "<script src='./js/check_attendance.js'></script>";
                    $conn->close();
                    ?>
                </div>
        </div>
