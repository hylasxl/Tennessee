            ...
            <div class="data-row container w-100 justify-content-center ms-3 me-3">
                ...
                <div class="data-query">
                    ...
                    <div class=\"col text-center col-2 \">
                        <button id='$courseID' style='width: 70%; border: none; background-color: #d31245; color: white;'  class='view_btn'>View Lessons</button>
                    </div>
                    </div>
                ");
                    }
                    echo "<script src='./js/teacher_classes.js'></script>";
                    $conn->close();
                    ?>
                </div>
        </div>
