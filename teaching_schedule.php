...
<body>
    ...
    <?
                    ...
                    $event = $conn->query("SELECT * from lecturer_timetable where lecturerID='$id'");
                    ...
                    while($row=$event->fetch_assoc()){
                        ...
                        $room = $row['roomID'];
                        $room = $conn->query("SELECT * from room where id='$room'");
                        $room = $room->fetch_assoc();
                        $roomName = $room['name'];
                        $eventName = "$courseName  <br> $lessonName <br> $timeStart - $timeEnd<br>$roomName";
                        echo "<script>
